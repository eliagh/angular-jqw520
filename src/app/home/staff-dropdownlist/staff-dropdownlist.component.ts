...
@Component({
  selector: 'app-staff-dropdownlist',
  templateUrl: './staff-dropdownlist.component.html',
  styleUrls: ['./staff-dropdownlist.component.css']
})
export class StaffDropdownlistComponent {
  ...
  renderer = (index: number, label: string, value: any): string => {
    ...
    const table = '<table style="min-width: 150px;"><tr><td style="width: 55px;" rowspan="2">'
      ...
      + datarecord.lastname + '</td></tr><tr><td>' + datarecord.title + '</td></tr></table>';
    return table;
  };
  ...
  generateData(): any[] {
    ...
    const titles = ['Sales Representative', 'Vice President, Sales', 'Sales Representative',
      'Sales Representative', 'Sales Manager', 'Sales Representative', 'Sales Representative',
    ...
    const address = ['507 - 20th Ave. E. Apt. 2A', '908 W. Capital Way', '722 Moss Bay Blvd.',
      '4110 Old Redmond Rd.', '14 Garrett Hill', 'Coventry House', 'Miner Rd.', 'Edgeham Hollow',
    ...
    const homephone = ['(206) 555-9857', '(206) 555-9482', '(206) 555-3412', '(206) 555-8122',
